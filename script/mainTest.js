...
backBtn.onclick=function(){
    ...
    if (test.currentQuestionIndex-1<0){
        ...
        test.createdQuestions[test.currentQuestionIndex].html.style.display="none";
    ...
    // if(test.createdQuestions[test.currentQuestionIndex+1].usersAnswer){
    //     test.createdQuestions[test.currentQuestionIndex+1].html.querySelector(`li[data-ans=${test.createdQuestions[test.currentQuestionIndex+1].usersAnswer}]`).firstElementChild.checked=true;
    // }
